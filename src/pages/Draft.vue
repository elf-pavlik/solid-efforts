...
<template>
  ...
  >
    ...
    <section v-if="draft.specifies!.length">
      <product-implementations-table
        :products="draft.specifies"
      ></product-implementations-table>
    </section>
    ...
    <section v-if="draft.explains">
      <h4>Explains</h4>
      <draft-list-item
        :draft="draft.explains"
        :icon="ldo.draftIcon(draft.explains)"
        @click="ldo.show(draft.explains)"
      ></draft-list-item>
    </section>
    ...
    <section v-if="primers.length">
      ...
      <v-list>
        <draft-list-item
          v-for="primer of primers"
          :draft="primer"
          :icon="ldo.draftIcon(primer)"
          @click="ldo.show(primer)"
        ></draft-list-item>
